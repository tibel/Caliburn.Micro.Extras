namespace Caliburn.Micro.Extras {
    ...
    public static class ResultExtensions {
        ...
        /// <returns></returns>
        public static IResult WhenCancelled(this IResult result, Func<IEnumerable<IResult>> coroutine) {
        ...
        /// <returns></returns>
        public static IResult Rescue<TException>(this IResult result, Func<TException, IEnumerable<IResult>> rescue, bool cancelResult = true)
        ...
        /// <param name="cancelResult">Set to true to cancel the result after executing rescue.</param>
        /// <returns></returns>
        public static IResult Rescue(this IResult result, Func<Exception, IEnumerable<IResult>> rescue, bool cancelResult = true) {
